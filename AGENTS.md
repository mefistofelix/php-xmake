...
| `nghttp2` | Active | Static library | All 26 C sources under `in/deps/nghttp2/lib/*.c` | `out/nghttp2.lib` | HTTP/2 transport required by libcurl/PHP | First callback attempt exposed Lua multi-return handling; minimal fix pending retest |
