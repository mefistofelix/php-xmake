...
| `libssh2` | Not yet defined | Static library | Official `libssh2-1.11.1` source tree | `out/libssh2.lib` | SSH transport required by libcurl/PHP | Clean official-source preparation passed; no-change repeat and target pending |
