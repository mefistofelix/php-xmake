...
- The private compile interface uses the upstream Windows defines, `STATIC_LEGACY`, and the complete x64 assembly feature set. Public consumers need only the generated headers; no static-consumer define is required. Propagate the upstream Windows system-library closure `ws2_32`, `gdi32`, `advapi32`, `crypt32`, and `user32`.
