...
for my $output (@ARGV) {
    ...
    add_files("in/deps/openssl/crypto/modes/gcm128.c", {unity_group = "conflict_11"})
    add_files("in/deps/openssl/crypto/modes/cts128.c", {unity_group = "conflict_12"})
    add_files("in/deps/openssl/crypto/modes/ctr128.c", {unity_group = "conflict_13"})
    ...
    add_files("in/deps/openssl/crypto/ct/ct_oct.c", {unity_group = "conflict_53"})
    add_files("in/deps/openssl/crypto/ct/ct_policy.c", {unity_group = "conflict_54"})
    add_files("in/deps/openssl/crypto/ct/ct_prn.c", {unity_group = "conflict_55"})
    add_files("in/deps/openssl/crypto/ct/ct_sct.c", {unity_group = "conflict_56"})
    add_files("in/deps/openssl/crypto/ct/ct_sct_ctx.c", {unity_group = "conflict_57"})
    add_files("in/deps/openssl/crypto/ct/ct_vfy.c", {unity_group = "conflict_58"})
