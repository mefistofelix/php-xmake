...
- [ ] Image/font stack: libpng, libjpeg, FreeType, libwebp, libtiff, and the unified `avif` target (libavif + libheif + AOM + libyuv + dav1d) are complete; libjxl and libultrahdr remain. The separate TurboJPEG API/library and XPM/libXpm are intentionally omitted.
