...
- [ ] Image/font stack: libpng, libjpeg, FreeType, and libwebp complete; libtiff is the current target. libavif, libheif, libjxl, and libultrahdr remain. The separate TurboJPEG API/library and XPM/libXpm are intentionally omitted.
