...
- [ ] Image/font stack: libpng, libjpeg, and FreeType complete; libwebp is the current target. libtiff, libavif, libheif, libjxl, and libultrahdr remain. The separate TurboJPEG API/library and XPM/libXpm are intentionally omitted.
